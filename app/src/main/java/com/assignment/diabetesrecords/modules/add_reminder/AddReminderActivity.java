...
public class AddReminderActivity extends AppCompatActivity  implements TimePickerDialog.OnTimeSetListener,
    ...
    private EditText dateet, timeet, titleet, descriptionet;
    ...
    private  long addEventToCalendar()
    {
      ...
      //  sStartTime= timeet.getText().toString();
        ...
        calendar_event_id= PushAppointmentsToCalender.pushAppointmentsToCalender(AddReminderActivity.this, titleet.getText().toString(), descriptionet.getText().toString(), "",iStatus, startDate, startDate, true, false, 0, "" );
