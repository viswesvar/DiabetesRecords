...
public class AddAppointmentActivity extends AppCompatActivity  implements TimePickerDialog.OnTimeSetListener,
    ...
    private  long addEventToCalendar()
    {
        ...
        calendar_event_id= PushAppointmentsToCalender.pushAppointmentsToCalender(AddAppointmentActivity.this, sTitle, sTitle, "",iStatus, startDate, startDate, true, false, 0, "" );
